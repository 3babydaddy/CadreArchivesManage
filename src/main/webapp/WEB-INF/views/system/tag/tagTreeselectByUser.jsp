...
<body>
	<div id="search" class="form-search hide" style="padding:10px 0 0 13px;">
		<label for="key" class="control-label" style="padding:5px 5px 3px 0;font-size:25px;">关键字：</label>
		<input type="text" class="empty" id="key" name="key" maxlength="50" style="width:180px;height:36px;">
		<button class="btn btn-large" id="btn" onclick="searchNode()" style="font-size:25px;">搜索</button>
	</div>
