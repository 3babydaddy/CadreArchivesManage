...
<body>
	...
	<div class="content">
		<form:form id="inputForm" modelAttribute="tblConsultArchives" action="" method="post" class="form-horizontal">
			<form:hidden path="id"/>
												...
												<tr id="tblCheckPersonList{{idx}}">
													...
													<td>
														<div class="fr"><label>签字：</label>
															...
															<input id="tblCheckPersonList{{idx}}_siginName" name="tblCheckPersonList[{{idx}}].siginName" type="hidden"  value="{{row.siginName}}"  maxlength="120" class="input3"/>
														
															<img id="tblCheckPersonList{{idx}}_siginImg" class="input3" style="display:none;width:383px;" src="{{row.siginName}}" />
															<a id="tblCheckPersonList{{idx}}_aline" style="display:none;" onclick="delSigin(this)">&times;</a>
       							 						</div>
													</td>
												</tr><tr style="height:25px;"><td colspan="5"></td></tr>
											</tr>//-->
